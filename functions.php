...
$social_networks = array("facebook" => "Facebook", "twitter" => "Twitter", "google-plus" =>  "Google Plus", "behance" => "Behance", "dribbble" => "Dribbble", "linkedin" => "Linked In", "youtube" => "Youtube", 'vimeo-square' => 'Vimeo', "vk" => "VK", "vine" => "Vine", "digg" => "Digg", "skype" => "Skype", "instagram" => "Instagram", "pinterest" => "Pinterest", "github" => "Github", "bitbucket" => "Bitbucket", "stack-overflow" => "Stack Overflow", "renren" => "Ren Ren", "flickr" => "Flickr", "soundcloud" => "Soundcloud", "steam" => "Steam", "qq" => "QQ", "slideshare" => "Slideshare", 'discord' => 'Discord', 'quora' => 'Quora', 'product-hunt' => 'Product Hunt', 'spotify' => 'Spotify', 'telegram' => 'Telegram', "rss" =>  "RSS", 'wikipedia-w' => 'Wikipedia');
...
function asalah_scripts() {
	...
	if ( !is_rtl() ) {
		wp_enqueue_style( 'asalah-style', get_stylesheet_uri(), array(), '3.520');
	}else{
		wp_enqueue_style( 'asalah-rtl-base', get_template_directory_uri() . '/rtl_base.css', array(), '3.520' );
	}
	...
	if (asalah_cross_option('asalah_pagination_style') == 'ajax') {
		global $wp_query;
		wp_enqueue_script( 'asalah-ajax-script', get_template_directory_uri() . '/js/ajaxpagination.js', array( 'jquery'), '3.520', true );
	...
	if (!isset($current_theme_version) || ($current_theme_version != $theme->get('Version'))) {
		...
		<div class="updated is-dismissable notice sanabel-update" style="position:relative;">
			...
			<h2>You have updated to version <?php echo $theme->get("Version"); ?>, Look what we have brought:</h2>
				...
				<ul>
					<li>- Fix Default share image issue at home page.</a>
					<li>- Add Wikipedia link to social media links.</a>
